...
The purpose of this project is to provide mechanisms for developing, testing and deploying Storj miners.

__NOTES:__ this project uses git submodules so you will want to clone recursively to have all expected behaviours.

```
git clone --recursive git@github.com:svo/storj-miner.git
```
...
Jenkins builds on commits and is available at: http://vagrant-storj-miner-ci.local:8080/
